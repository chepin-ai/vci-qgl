<!-- CLASSIFY: L0 -->
# vci-qgl —— quantum-go-ledger 之公域 CI 影子引擎（SHADOW-CI-01 矩阵 · 业务线影子）

**意图**：公域影子：消费 qgl 线 outbox/weave 公开件，跑公开校验与基准，发布摘要
...
- 引擎升级经 provision 车道（ci-control/provision/vci/vci-qgl/）幂等下发。
